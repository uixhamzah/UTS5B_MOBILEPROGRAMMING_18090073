    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listResultViewModel.getClinicLocation().observe(this) { modelResults: ArrayList<ModelResults?> ->
            if (modelResults.size != 0) {
                ...
                Toast.makeText(this, "Oops, lokasi Apotek tidak ditemukan!", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
...
private fun <T> LiveData<T>.observe(clinicActivity: ClinicActivity, function: (ArrayList<ModelResults?>) -> Unit) {
